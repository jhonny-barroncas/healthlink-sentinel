...
- Em 2026-09-04, a lateral operacional do mapa estadual recebeu menu contextual por hover/foco/toque em cada unidade, com ações para abrir, editar, consultar relatórios e abrir telemetria. A lateral continua sem listar alertas e ganhou o seletor `Exibir` (`Tudo`, `Somente links`, `Somente equipamentos`). Os sparklines de ping passaram a usar escala estável de 0–250 ms e duas camadas (trilha e pulso animado) sobre o histórico real, incluindo o ping manual mais recente.
