...
- Atualização 2026-09-04: os cards de unidade na lateral receberam menu contextual por hover e foco, com toque como fallback, oferecendo abrir unidade, editar, relatórios e telemetria. A lateral permanece estritamente operacional, não lista alertas e pode filtrar o conteúdo expandido entre tudo, somente links ou somente equipamentos. A trilha e o pulso animado dos sparklines seguem o histórico real e o ping manual mais recente.
- Correção 2026-09-04: o sparkline compacto passou a normalizar a escala pelo intervalo das amostras recentes. Isso mantém visíveis variações submilissegundo, como `0,30 → 0,55 → 0,20 ms`, sem alterar as dimensões ou o designer do card.
- O gráfico da análise detalhada reutiliza a mesma composição visual e escala adaptativa do sparkline compacto: trilha, pulso animado e ponto final luminoso. A área e o layout do modal permanecem inalterados, e o tooltip continua selecionando a amostra pelo eixo X.
- Ajuste de interação 2026-09-04: `+` e seta são controles independentes. Hover/foco no `+` abre as ações; hover/foco na seta apenas realça o controle e o clique expande/recolhe os ativos. O submenu usa fundo sólido para preservar contraste sobre o mapa.
- Refinamento posterior: a entrada do ponteiro na seta também expande o card, mantendo-o aberto para que o operador mova o cursor até os links e equipamentos. O clique continua alternando expansão como fallback de acessibilidade e toque.
- O gráfico detalhado de latência usa seleção por eixo X: qualquer posição horizontal sobre o plot encontra a amostra mais próxima e mostra seu valor em milissegundos e horário.
