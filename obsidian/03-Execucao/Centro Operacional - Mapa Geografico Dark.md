...
- Atualização 2026-09-04: os cards de unidade na lateral receberam menu contextual por hover e foco, com toque como fallback, oferecendo abrir unidade, editar, relatórios e telemetria. A lateral permanece estritamente operacional e não lista alertas. Os sparklines usam escala estável de `0–250 ms`; a trilha e o pulso animado seguem o histórico real e o ping manual mais recente.
